 ...
 * For converting char array to String, you need to use the String constructor that takes char array argument i.e new String(char[] chArr).
 * Also note that the two Strings are equal in value but they are not referring to same String because the second String is created using new operator.
 *
 */
