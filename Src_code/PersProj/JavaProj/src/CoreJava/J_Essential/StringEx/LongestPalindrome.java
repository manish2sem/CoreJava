 ...
 * Think recursively:
 * 
 * Find recursion terminator
 * 
 * Find the sub problem and solve it.
 * 	Key point: Forming subproblem
 ...
 *   We will have two global variables to save the start and end position for palindrome. 
 *   We also need to check if there is already a longer palindome found since there can we multiple palindome in the given string.
 * @author sinhama
 *
 */
