...
/**
 * When you need to simplify or unify large IF or complex set of IF's use a FACADE.
 * You can implement more than one facade for a sub system.
 * @author sinhama
 *
 */
...
/**
 * Facad and Adapter both Wrap multiple classes 
 * but facad's intent is to simplify 
 * while adapter's is to convert the interface to something different.
 */ 
